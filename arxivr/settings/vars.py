...
DETECTOR_TRAIN_DATA_PATH = '/floyd/input/detector/detector/train/flikr/train/'
...
SCFEGAN_DATA_INPUT_PATH = 'F:/celeba-dataset/img_align_celeba/'
SCFEGAN_INP_SHAPE = (256, 256)
